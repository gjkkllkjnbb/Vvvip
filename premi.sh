...
echo -e "       © Recode By MAZ FARUK ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 5
###### IZIN SC 
...
data_ip="https://raw.githubusercontent.com/Nixxx-XD/Vvvip/main/izin"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6283805609815"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Nixxx-XD/Vvvip/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Nixxx-XD/Vvvip/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Nixxx-XD/Vvvip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Nixxx-XD/Vvvip/main/"
...
function password_default() {
    ...
    CHATID="6630028565"
    KEY="6748383047:AAHaVFe4jXAxrBXBln9gg9W_Fse8VVM32bI"
    TIME="10"
